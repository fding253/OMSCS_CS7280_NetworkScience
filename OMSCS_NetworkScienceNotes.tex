...
%TODO finish delta maps notes + remainder of lesson 8
...
% TODO: food for thought: show R_0 for SIS/SIR
...
% TODO: Food for Thought: why is the Independent Contagion model consistent with the Diminishing Returns theory of social influence?
...
\begin{itemize}
	\item If the state of two connected nodes, u and v, differ by more than the threshold: $|s_v(t)-s_u(t) | \geq \delta$, then the two neighbors "disagree" so strongly that they do not influence each other, and their state remains as is. % typo in lecture notes? -- "state is greater than the threshold"
...
%TODO: Food for Thought: Prove that a non-negative linear combination of a set of submodular functions is also a submodular function.
...
%\subsubsection{Experimental Validation of ALT Model}
